 ...
 */
class CampaignSite extends \Core\Entity\CampaignSite implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'campaign', 'site', 'created_at', 'started_at', 'ended_at', 'status');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CampaignSite $proxy) {
