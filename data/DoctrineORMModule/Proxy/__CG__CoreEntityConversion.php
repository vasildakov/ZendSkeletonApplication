 ...
 */
class Conversion extends \Core\Entity\Conversion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'reference', 'user_id', 'campaign_id', 'site_id', 'rate_id', 'type', 'status');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Conversion $proxy) {
